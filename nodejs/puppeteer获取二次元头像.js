...
(async () => {
  ...
  await page.goto('https://www.thiswaifudoesnotexist.net/'); //跳转到掘金
  //请开始你的表演...
  const dimensions = await page.evaluate(() => {
    return {
      image: document.getElementsByClassName('image-container')[0].getElementsByTagName('img')[0].src
    };
  });

  console.log('Dimensions:', dimensions.image);
